            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::user()->role_id == 2)
                        <x-nav-link :href="route('infirmier.dashboard')" :active="request()->routeIs('infirmier.dashboard')">
                            {{ __('Infirmier') }}
                        </x-nav-link>
                    ...
                    @if (Auth::user()->role_id == 3)
                        <x-nav-link :href="route('laboratoire.dashboard')" :active="request()->routeIs('laboratoire.dashboard')">
                            {{ __('Laboratoire') }}
                        </x-nav-link>
                    @endif
                </div>
