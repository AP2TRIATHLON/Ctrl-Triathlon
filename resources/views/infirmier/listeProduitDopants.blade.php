    ...
    <div class="py-12">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-8 flex justify-between items-end">
                <div>
                    <h3 class="text-2xl font-bold text-gray-900 dark:text-white">Produits dopants</h3>
                    <p class="text-gray-500 dark:text-gray-400">Voici tout les produit dopants.</p>
                </div>
                <div class="bg-blue-600 text-white px-4 py-2 rounded-lg shadow-md font-bold">
                    {{ $produitsDopants->count() }} Produits
                </div>
            </div>

            @if ($produitsDopants->isEmpty())
                <div class="bg-white dark:bg-gray-800 rounded-2xl p-12 text-center shadow-sm border border-dashed border-gray-300 dark:border-gray-700">
                    <p class="text-gray-500 dark:text-gray-400 text-lg">Aucun produit dopant répertorié.</p>
                </div>
            @else
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    @php $nombre = 0 @endphp
                    @foreach ($produitsDopants as $nom)
                        <div class="group relative bg-white dark:bg-gray-800 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700 overflow-hidden cursor-pointer transform hover:-translate-y-1">
                            ...
                            <div class="p-6">
                                <div class="flex items-start justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <p class="text-xs text-gray-400 uppercase tracking-widest font-semibold mt-1">Produit dopant</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-6 flex items-center justify-between text-sm">
                                    ...
                                    <div class="flex items-center text-gray-200 dark:text-blue-400 font-bold group-hover:translate-x-2 transition-transform">
                                        Voir la fiche
                ...
                <div class="mt-10 py-4 border-t border-gray-200 dark:border-gray-700">
                    <p class="text-gray-500 dark:text-gray-400 italic text-sm text-center">
                        Synthèse : {{ $nombre }} établissements disponibles.
                    </p>
                </div>
            @endif
        </div>
